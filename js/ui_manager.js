...
const UIManager = (() => {
  ...
  const BUTTONS = {
    ...
    settings: [  // ТОЧНЫЙ скан границ 17.09.2026
      ...
      { id: 'reset', x: 71,  y: 500, w: 338, h: 73 },  // СБРОС ПРОГРЕССА (двойной клик). Было 75/505/405x62 — зона уходила до края экрана 480, хотя строка кончается на 409
  ...
  // ⚠️ ВРЕМЕННО ДЛЯ ПРОВЕРКИ КНОПКИ СБРОСА (запрос 20.09.2026) ⚠️
