...
const Tentacles = (() => {
  ...
  // 17.09.2026: пороги уменьшены вдвое (было 500/1000/1500/2000) — начало игры
  // ощущалось слишком пустым, до полного состава червей нужно было 2000 кристаллов.
  const LAUNCH_ORDER = [
    { id: 'T1', unlock: 0    },
    { id: 'T6', unlock: 0    },
    { id: 'T5', unlock: 250  },
  ...
  // Тайминги НЕ меняем: 2400мс между стартами даёт минимальный зазор 1600мс
  // между головами на одной платформе — на этом построены правила безопасности.
